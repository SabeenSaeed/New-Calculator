...
`));
        ...
        {
        case 'add':result = answer.num1 + answer.num2 
            console.log(chalk.yellow(`Your answer is : ${result}`))
        break;
            
        case 'subtract':result = answer.num1 - answer.num2 
            console.log(chalk.cyan(`Your answer is : ${result}`))
        break;
                    
        case 'multiply':result = answer.num1 * answer.num2 
            console.log(chalk.green(`Your answer is : ${result}`))
        break;
                    
        case 'divide':result = answer.num1 / answer.num2 
